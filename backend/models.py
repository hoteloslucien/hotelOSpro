...
class Zone(Base):
    ...
    code=Column(String(100),nullable=True); type=Column(String(100),nullable=True)  # zone, lieu, etage, secteur, batiment, aile
...
class Service(Base):
    ...
    id=Column(Integer,primary_key=True,index=True); name=Column(String(100),nullable=False)
    code=Column(String(100),unique=True,nullable=False); hotel_id=Column(Integer,ForeignKey("hotels.id"),nullable=False)
...
class AuditLog(Base):
    ...
    hotel_id=Column(Integer,ForeignKey("hotels.id"),nullable=True); action=Column(String(100),nullable=False)
    entity_type=Column(String(100),nullable=True); entity_id=Column(Integer,nullable=True); detail=Column(Text,nullable=True)
    created_at=Column(DateTime(timezone=True),server_default=func.now())
...
class User(Base):
    ...
    role=Column(String(100),default="technicien"); service=Column(String(100),nullable=True)
...
class Room(Base):
    ...
    floor=Column(Integer,default=1); type=Column(String(100),default="standard")
    status=Column(String(100),default="sale"); is_available=Column(Boolean,default=True)
...
class Task(Base):
    ...
    description=Column(Text,nullable=True); status=Column(String(100),default="a_faire")
    priority=Column(String(10),default="normale"); service=Column(String(100),nullable=True)
...
class Intervention(Base):
    ...
    status=Column(String(100),default="nouvelle"); priority=Column(String(10),default="normale")
    source=Column(String(100),default="staff"); cost=Column(Float,default=0.0)
...
class Round(Base):
    ...
    id=Column(Integer,primary_key=True,index=True); name=Column(String(100),nullable=False)
    date=Column(DateTime(timezone=True),nullable=False); status=Column(String(100),default="planifiee")
...
class RoundRoom(Base):
    ...
    status=Column(String(100),default="en_attente"); note=Column(Text,nullable=True)
    completed_at=Column(DateTime(timezone=True),nullable=True)
...
class Message(Base):
    ...
    channel=Column(String(100),default="general"); is_urgent=Column(Boolean,default=False); is_read=Column(Boolean,default=False)
    hotel_id=Column(Integer,ForeignKey("hotels.id"),nullable=True)
...
class ClientReview(Base):
    ...
    category=Column(String(100),nullable=True); comment=Column(Text,nullable=True)
    guest_name=Column(String(100),nullable=True); status=Column(String(100),default="nouveau")
...
class Equipment(Base):
    ...
    id=Column(Integer,primary_key=True,index=True); name=Column(String(150),nullable=False)
    category=Column(String(100),nullable=True); brand=Column(String(100),nullable=True)
    model=Column(String(100),nullable=True); serial_number=Column(String(100),nullable=True)
    location=Column(String(100),nullable=True); status=Column(String(100),default="operationnel")
...
class EquipmentItem(Base):
    ...
    status=Column(String(100),default="ok",nullable=False)
...
class StockItem(Base):
    ...
    id=Column(Integer,primary_key=True,index=True); name=Column(String(150),nullable=False)
    reference=Column(String(100),nullable=True); category=Column(String(100),nullable=True)
    unit=Column(String(100),default="unite"); quantity=Column(Float,default=0.0)
...
class StockMovement(Base):
    ...
    id=Column(Integer,primary_key=True,index=True); type=Column(String(100),nullable=False)
...
class AttendanceShift(Base):
    ...
    hotel_id=Column(Integer,ForeignKey("hotels.id"),nullable=True); service=Column(String(100),nullable=True)
    ...
    status=Column(String(100),default="scheduled"); late_minutes=Column(Integer,default=0); notes=Column(Text,nullable=True)
    created_at=Column(DateTime(timezone=True),server_default=func.now()); updated_at=Column(DateTime(timezone=True),onupdate=func.now())
...
class AttendanceEvent(Base):
    ...
    user_id=Column(Integer,ForeignKey("users.id"),nullable=False); event_type=Column(String(100),nullable=False)
...
class Conversation(Base):
    ...
    type=Column(String(100),default="direct")  # direct, group
...
class ConversationParticipant(Base):
    ...
    role_in_conv=Column(String(100),default="member")  # member, admin
    is_active=Column(Boolean,default=True)
...
class ConvMessage(Base):
    ...
    body=Column(Text,nullable=False); message_type=Column(String(100),default="text")
    created_at=Column(DateTime(timezone=True),server_default=func.now())
...
class NotificationPreference(Base):
    ...
    channel = Column(String(100), default="app")
